...
static double check_case(int m, int n, int k, int workers, int tb)
{
    ...
    for (int change = 0; change < 3; ++change) {
        ...
        assert(!camblas_experimental_rectangular64_f64_op(tb, &camblas_executor_serial, workers, m,
    ...
    assert(camblas_experimental_rectangular64_f64(&camblas_executor_serial, workers, m, n, k, a,
